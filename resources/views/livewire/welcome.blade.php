...
<div id="loading">
    @if($pid)
        ...
        <img class="welcome_background" src='header-images/welcomebg.jpg'>    
        <div class="welcome_wrapper">
            @if($lang == 'Ro')
                <img style="width:550px; height:auto;" class="welcome_img"  src='header-images/cutrow.png'> 
            @else
                <img style="width:550px; height:auto;" class="welcome_img"  src='header-images/cutenw.png'> 
            @endif
            <a class="custom_btn2">
                <span> 
                    <span class="welcome_info-wrapper">
                        <strong class="superbold full_width">
                            <div class="full_width d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    <img style="width:40px; height:auto;"  src='header-images/BONUS.png'> 
